...
if (!window.__GOOGLE_PHOTOS_EXTENSION_LOADED) {
  ...
  (function () {
    ...
    const detectEmailFromPage = () => {
      ...
      const allElements = document.querySelectorAll('header a, header span, [data-email]');
    ...
    const POLL_MS = 200;
    const TRASH_PATTERN = /move to trash|chuyển vào thùng rác|đưa vào thùng rác|delete|xóa|thùng rác/i;
